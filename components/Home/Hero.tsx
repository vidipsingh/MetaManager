    ...
    <div className='mb-20'>
        ...
        <div className='w-full text-white flex flex-col items-center justify-center text-center lg:mt-10 md:mt-14 sm:mt-16 mt-8'>
          <div className='lg:w-1/3 md:w-1/2 sm:w-1/2 w-3/4 border border-gray-600 dark:border-gray-400 p-4 rounded-md'>
            ...
            <Link href="/login"> <button className='dark:bg-white dark:text-black bg-black text-white hover:bg-white hover:text-black px-10 py-1 rounded-md shadow-md dark:hover:bg-gray-400 font-semibold'>Login</button> </Link>
            <Link href="/signup"> <button className='dark:bg-white dark:text-black bg-black text-white hover:bg-white hover:text-black px-10 py-1 rounded-md shadow-md font-semibold'>Signup</button> </Link>
          </div>
          </div>
        </div>
