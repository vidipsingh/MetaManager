...
const Header = () => {
  return (
    <>
      <div className="bg-gray-800 bg-opacity-50 backdrop-blur-lg text-white flex py-2 px-6 border border-gray-400 rounded-full items-center mx-20 justify-between">
        <div className="text-lg hover:cursor-pointer hover:text-gray-300 font-semibold">
          MetaManager
        </div>
