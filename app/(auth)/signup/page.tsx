          ...
          <div className='flex justify-between md:w-1/2 lg:w-2/5 text-white px-4'>
            <div className='w-full p-5 border border-gray-400 rounded-md bg-black/90'>
              <div>
                ...
                <h1 className='my-3'>Already have an account? 
                  <Link href="/login">
                    <span className='text-purple-300 underline hover:text-purple-400 cursor-pointer'>
                      Sign In
                    </span>
                  </Link>
                </h1>
              ...
              <form className='flex flex-col mt-6' onSubmit={handleRegister}>
                ...
                <button 
                  type='submit' 
                  className='w-full text-lg bg-purple-900 py-1.5 rounded-sm hover:bg-purple-950'
                >
                  Sign Up
                </button>
              </form>
